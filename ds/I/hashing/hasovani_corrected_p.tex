...
$\left(h_1\left(x\right)+ih_2\left(x\right)\right)\bmod m$ je pr\'azdn\'y \v r\'adek, a tam ulo\v z\'\i me 
prvek $x$.\newline 
...
$|U_i|\ge\left\lceil\frac {|U_{i-1}|}m\right\rceil$. Proto\v ze $|U_0|=N$, dost\'av\'ame indukc\'\i , \v ze 
...
nalezne v \v case $O\left(n\right)$ takov\'e $k$, \v ze $\sum_{i=0}^{m-1}\left(b_
i^k\right)^2<4n$ -- o\v cek\'avan\'y po\v cet iterac\'\i\ v\'ypo\v ctu je nejv\'y\v se $
4$.
\endroster
D\'ale 
\roster
