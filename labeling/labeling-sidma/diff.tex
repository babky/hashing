...
%DIF ADD lab-fix.tex                    Sat Jun 16 13:16:04 2018
...
\DIFaddbegin \DIFadd{We provide an adversary algorithm providing input for a given online labeling algorithm so that the algorithm is forced to make many relabelings.
...
in the critical segment. \DIFaddbegin \DIFadd{In the case when the critical segment has no successor (sub)segment, then the amount of items 
