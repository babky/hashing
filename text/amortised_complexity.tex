...
All of the following statements, that are used in the following computation and may be found in \cite{Jeffrey:1177618},
\begin{gather*}
...
% Let $\{o_i\}_{i = 1}^{n}$ be the sequence of $n \in \mathbb{N}$ operations. 
