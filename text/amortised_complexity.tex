...
\begin{definition}[Chain length limiting function, long chain, trimming rate]
...
One can find a better potential function proving the previous result more formally. We use such an explicitly expressed potential function when the delete operation is also allowed.
...
The fraction $\frac{(ce - r)m}{o}$ converges to $1$ with the growing number of operations, $o$. This follows from the Weak Law of Large Numbers -- Theorem \ref{theorem-chebyshev-inequality}.
\end{proof}
