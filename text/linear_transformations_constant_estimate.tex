...
Let the $d$ denote the base of the exponentiation, $d = \frac{r}{\log r}$. And put the $d$ equal to $k \log n$ for a positive constant $k$. Then the following must be achieved:
\begin{displaymath}
