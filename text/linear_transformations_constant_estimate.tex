...
Let $d = k \log n$ and $d \leq \frac{r}{\log r}$ for a positive constant $k$. Since function $d^{\log \log n -\log d - \log \log d}$ is decreasing when the exponent is negative the previous inequality holds if
\begin{displaymath}
