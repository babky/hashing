...
All of the~following claims in this section are taken from \cite{linear-hash-functions}. It is convenient to show the~original proofs and then modify them according to our future needs.
