...
{\bf Dvojita}-{\bf rotace$\left(u,v,w\right)$\newline 
...
\phantom{---------}{\bf else}\newline 
\phantom{------------}$t_2:=\pravy\left(t\right)$, {\bf Dvojita-rotace$\left(v,t,t_2\right)$},\newline 
\phantom{------------}{\bf if} $\omega \left(t_2\right)=0$ {\bf then}\newline 
\phantom{---------------}$\omega \left(t\right):=0$, $\omega \left(v\right):=0$\newline 
\phantom{------------}{\bf else}\newline 
\phantom{---------------}{\bf if} $\omega \left(t_2\right)=1$ {\bf then}\newline 
\phantom{------------------}$\omega \left(v\right):=0$, $\omega \left(t\right):=-1$\newline 
\phantom{---------------}{\bf else}\newline 
\phantom{------------------}$\omega \left(v\right):=1$, $\omega \left(t\right):=0$\newline 
\phantom{---------------}{\bf endif}\newline 
\phantom{------------}{\bf endif}\newline 
\phantom{------------}$\omega \left(t_2\right):=0$\newline 
\phantom{---------}{\bf endif}\newline
\phantom{------}{\bf endif}\newline 
\phantom{---}{\bf endif\newline 
else}\newline 
...
\phantom{---------}{\bf endif}\newline 
\phantom{------}{\bf else}\newline 
\phantom{---------}$u_2:=\pravy\left(u\right)$, {\bf Dvojita-rotace$\left(v,u,u_2\right)$}\newline 
\phantom{---------}{\bf if} $\omega \left(u_2\right)=1$ {\bf then}\newline 
\phantom{------------}$\omega \left(u\right):=-1$, $\omega \left(v\right):=0$\newline 
\phantom{---------}{\bf else}\newline 
\phantom{------------}{\bf if} $\omega \left(u_2\right):=0$ {\bf then}\newline 
\phantom{---------------}$\omega \left(u\right):=0$, $\omega\left(v\right):=0$\newline 
\phantom{------------}{\bf else}\newline 
\phantom{---------------}$\omega \left(u\right):=0$, $\omega \left(v\right):=1$\newline 
\phantom{------------}{\bf endif}\newline 
\phantom{---------}{\bf endif}\newline 
\phantom{---------}$\omega \left(u_2\right):=0$, $t:=u_2$, {\bf Kontrola-Delete}$\left(t\right)$\newline
\phantom{------}{\bf endif}\newline 
\phantom{---}{\bf else}\newline 
\phantom{------}{\bf if} $\omega \left(v\right)=0$ {\bf then}\newline 
\phantom{---------}$\omega \left(v\right):=-1$\newline 
...
\flushpar $\left(a,b\right)$-stromy zavedli Bayer a McGreght (1972),\newline 
...
\v Rada u\v zivatel\accent23u pou\v z\'\i v\'a  AVL-stromy, co\v z je d\accent23usledkem jejich dobr\'e efektivity a faktu, \v ze po dlouhou dobu to byla jedin\'a efektivn\'\i\ datov\'a struktura. Zd\'a se v\v sak, \v ze \v cerveno-\v cern\'e stromy jsou efektivn\v ej\v s\'\i\ a v sou\v casn\'e dob\v e jsou nejpou\v z\'\i van\v ej\v s\'\i m typem bin\'arn\'\i ch vyhled\'avac\'\i ch strom\accent23u. 
