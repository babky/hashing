...
We provide a hash table which uses linear space and provides a worst case guarantee for Find.
In fact, we analyze a simple modification of universal hashing with separate chaining and show that the method can be generalized.
